...
if(!dir.exists(dir_tmp)){
    ...
    download.file("https://wwwn.cdc.gov/Nchs/Nhanes/2003-2004/L13_C.XPT", destfile = file.path(dir_tmp,"L13_C.XPT"))
    # Blood Pressure: BPXSY1 , BPXSY2, BPXSY3 and BPXSY4
    download.file("https://wwwn.cdc.gov/Nchs/Nhanes/2003-2004/BPX_C.XPT", destfile = file.path(dir_tmp,"BPX_C.XPT"))

    ## download the lab measurement data for the cohort 2005-2006
    # Total Cholesterol: LBXTC
    download.file("https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/TCHOL_D.XPT", destfile = file.path(dir_tmp,"TCHOL_D.XPT"))
    # HDL Cholesterol: LBDHDD
    download.file("https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/HDL_D.XPT", destfile = file.path(dir_tmp,"HDL_D.XPT"))
    # Blood Pressure, up to 4 measurements per person: BPXSY1 , BPXSY2, BPXSY3 and BPXSY4
    download.file("https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/BPX_D.XPT", destfile = file.path(dir_tmp,"BPX_D.XPT"))
}
